...
val FlightsDataMap = hashMapOf(
	...
	"DUS" to listOf("SOY", "ATH", "ZRH", "HER", "DUB", "OPO", "KEF", "MAD"),
	...
	"ALC" to listOf("AGP", "SOY", "BGY", "BCN", "OPO", "GRA", "OSL", "VIE")
)